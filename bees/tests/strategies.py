...
def envs(draw) -> Dict[str, Any]:
    ...
    height = draw(st.integers(min_value=1, max_value=15))
    sight_len = draw(st.integers(min_value=1, max_value=15))
    ...
    time_steps = draw(st.integers(min_value=0))
    reuse_state_dicts = draw(st.booleans())
    policy_score_frequency = draw(st.integers(min_value=1))
    ema_alpha = draw(st.floats(min_value=0.0, max_value=1.0))
    n_layers = draw(st.integers(min_value=1))
    ...
    num_steps = draw(st.integers(min_value=1))
    ppo_epoch = draw(st.integers(min_value=1))
    num_mini_batch = draw(st.integers(min_value=1))
    clip_param = draw(st.floats(min_value=0.0, max_value=1.0))
    log_interval = draw(st.integers(min_value=1))
    save_interval = draw(st.integers(min_value=1))
    eval_interval = draw(st.integers(min_value=1))
    num_env_steps = draw(st.integers(min_value=1))
